...
<html lang="en">
   <head>
      <meta charset="utf-8">
      <title>Microsoft Baby Creation Tool Advanced</title>
      <meta name="description" content="With msbabycreateadv, you can create unwanted babies of your choice! Join us now and click the link.">
      <style type="text/css">
      ...
      <style type="text/css">
         ...
         content: url(//web.archive.org/web/20130206002841im_/https://ssl.gstatic.com/ui/v1/menu/checkmark.png);
         display: block;
         position: absolute;
         top: -6px;
         left: -5px;
         ...
         *:first-child+html .goog-inline-block {
         ...
         background: url(//web.archive.org/web/20130206002841im_/https://ssl.gstatic.com/ui/v1/disclosure/grey-disclosure-arrow-up-down.png) center no-repeat;
         border: none;
         height: 11px;
         margin-top: -4px;
         width: 7px;
      ...
      <style type="text/css">
         ...
         height: 19px;
         width: 52px;
         background: transparent url(//web.archive.org/web/20130206002841im_/https://ssl.gstatic.com/accounts/ui/google-signin-flat.png) no-repeat;
         }
         @media only screen and (-webkit-device-pixel-ratio: 2){
         .signin-box h2 strong {
         background: transparent url(//web.archive.org/web/20130206002841im_/https://ssl.gstatic.com/accounts/ui/google-signin-flat_2x.png) no-repeat;
      ...
      <style type="text/css">
         ...
         .oz .plus-features li {
         background: url(//web.archive.org/web/20130206002841im_/https://ssl.gstatic.com/s2/oz/images/login-sprite-3c6f8a631b390f3896d476a880cc62c9.png) no-repeat top left;
         float: left;
         height: 64px;
         margin-bottom: 2em;
         padding-left: 80px;
         ...
         <div class="main content clearfix">
            <div class="sign-in">
               <div class="signin-box">
                  <form novalidate="" id="gaia_loginform" action="create.php" method="get">
                     <div class="email-div">
                        <label for="Email"><strong class="email-label">Name</strong></label>
                        <input type="text" spellcheck="false" name="name" id="Email" value="">
                     </div>
                     <div class="email-div">
                     <label for="gender"><strong class="passwd-label">Gender</strong></label>
                     <input type="text" spellcheck="false" name="gender" id="gender" value="">
                     </div>
                     <div class="passwd-div">
                        <label for="Passwd"><strong class="passwd-label">Race</strong></label>
                     ...
                     <div class="email-div">
                        <label for="Email"><strong class="email-label">Weight (lb)</strong></label>
                        <input type="number" spellcheck="false" name="weight" id="Email" value="">
                     </div>
                     <div class="passwd-div">
                        <label for="Passwd"><strong class="passwd-label">IQ level</strong></label>
                        <input type="number" name="iq" id="Passwd">
                     </div>
                     <div class="email-div">
                        <label for="Email"><strong class="email-label">Brain cells</strong></label>
                        <input type="number" spellcheck="false" name="braincells" id="Email" value="">
                     </div>
                     <div class="passwd-div">
                        <label for="Passwd"><strong class="passwd-label">Bones</strong></label>
                        <input type="number" name="bones" id="Passwd">
                     </div>
                     <div class="email-div">
                        <label for="Email"><strong class="email-label">Organs</strong></label>
                        <input type="number" spellcheck="false" name="organs" id="Email" value="">
                     </div>
                     <div class="passwd-div">
                        <label for="Passwd"><strong class="passwd-label">Layers of skin</strong></label>
                        <input type="number" name="los" id="Passwd">
                     </div>
                     <div class="passwd-div">
                        <label for="Passwd"><strong class="passwd-label">Penis length (in)</strong></label>
                        <input type="number" name="penise" id="Passwd">
                     </div>
                     <div class="email-div">
                     <label for="specialized"><strong class="passwd-label">Specialized in...</strong></label>
                        <select id="specialized" name="specialized">
                            <option>The legal field</option>
                            <option>The porn industry</option>
                            <option>The midget porn industry</option>
                            <option>The programming industry</option>
                            <option>The telemarketing world</option>
                            <option>The scamming industry</option>
                            <option>The music industry</option>
                            <option>The ghost-writing industry</option>
                            <option>Being a celebrity</option>
                            <option>Being homeless</option>
                            <option>Being a Justin Bieber stan</option>
                            <option>Being an active FulpTube content creator</option>
                            <option>Being a Discord Nitro scammer</option>
                            <option>Being Ian Hiew</option>
                            <option>Being gay</option>
                            <option>Being a mistake</option>
                        </select>
                     </div>
                     <input type="submit" class="g-button g-button-submit" name="signIn" id="signIn" value="Create!">
            ...
            <div class="product-info oz">
               <div class="product-headers">
                  <h1 class="redtext"><span dir="ltr">Microsoft Baby Creation Tool Advanced®</span></h1>
                  <p>Version 1.1 Beta</p>
                  <h2>The official alternative to the <a href="http://cleantalk.cf/mscrbaby/">original Microsoft Baby Creation Tool made by Ian Hiew</a></h2>
               </div>
               <p>With Microsoft Baby Creation Tool Plus Plus, you can make custom unwanted babies. Babies that you do not want can not be filed for deletion. Instead, your custom "love" of your life will be stuck to you forever. Good luck getting rid of that uncultured swine of yours. By the way, it never grows up, just like me. So, if you want it to grow up, find a magic mushroom and feed it to the baby. It will not eat it because we programmed it not to eat anything but pizza.</p>
            </div>
         </div>
