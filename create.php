         ...
         <div class="main content clearfix">
            <div class="sign-in">
               <div class="signin-box">
                  <h4 style="text-align:center;"><strong>Baby Information</strong></h4>
                  <br>
                  <strong style="display:inline;">Name:</strong> <?php echo $_GET["name"]; ?>
                  <br>
                  <strong style="display:inline;">Gender:</strong> <?php echo $_GET["gender"]; ?>
                  <br>
                  <strong style="display:inline;">Race:</strong> <?php echo $_GET["race"]; ?>
                  <br>
                  <strong style="display:inline;">Weight (lb):</strong> <?php echo $_GET["weight"]; ?>
                  <br>
                  <strong style="display:inline;">IQ level:</strong> <?php echo $_GET["iq"]; ?>
                  <br>
                  <strong style="display:inline;">Brain cells:</strong> <?php echo $_GET["braincells"]; ?>
                  <br>
                  <strong style="display:inline;">Bones:</strong> <?php echo $_GET["bones"]; ?>
                  <br>
                  <strong style="display:inline;">Organs:</strong> <?php echo $_GET["organs"]; ?>
                  <br>
                  <strong style="display:inline;">Layers of skin:</strong> <?php echo $_GET["los"]; ?>
                  <br>
                  <strong style="display:inline;">Penis length (in):</strong> <?php echo $_GET["penise"]; ?>
                  <br>
                  <strong style="display:inline;">Specialized in:</strong> <?php echo $_GET["specialized"]; ?>
                  <br><br>
